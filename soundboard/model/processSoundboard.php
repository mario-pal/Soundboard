<?php
	...
	$sql = "INSERT INTO soundboards (user_id, soundboard_name, soundboard_image,soundboard_description, public, date_created, owner_user_name) 
	        VALUES 
		($userID, '$soundboard_name', NULL, '$soundboard_description', $public, '$todays_date', '$username')";
